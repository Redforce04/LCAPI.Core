// -----------------------------------------------------------------------
// <copyright file="GlobalSaveDataAttribute.cs" company="Lethal Company Modding Community">
...
public class GlobalSaveDataAttribute : Attribute
{
    /// <summary>
    ...
    public GlobalSaveDataAttribute(bool loadAutomatically = true)
    {
