...
public sealed class LocalSaveDataAttribute : Attribute
{
    ...
    public LocalSaveDataAttribute(bool autoLoad = true, AutoSaveMode autoSave = AutoSaveMode.GameSaved)
    {
        this.LocalSaveSettings = new SaveDataSettings(autoLoad, autoSave);
    }

    /// <summary>
    /// Gets contains the general settings for saving and loading data.
    /// </summary>
    internal SaveDataSettings LocalSaveSettings { get; }
}